...
Every report bundle also includes `engineering_review_coverage.md`,
`engineering_review_coverage.csv`, and `engineering_review_coverage.json`.
These summarize reviewed and complete alarm candidates plus verified,
rejected, unreviewed, and unresolved relationships. The CSV provides a stable
