"""Measure lossless Structured Text parse coverage in an L5X document."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Analyze captured Structured Text syntax coverage."
    )
    ...
    text = analyze_structured_text(controllers[0]).render_text()
    print(text, end="")
