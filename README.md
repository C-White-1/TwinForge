...
`report` accepts a Controller L5X export and writes twenty-three supported engineering
...
the generated engineering evidence. A module and spare-I/O schedule aggregates
known channel capacity while retaining unknown module capability. Unestablished
