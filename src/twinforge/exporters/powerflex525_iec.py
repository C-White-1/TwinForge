...
def powerflex525_codesys_multi_application_integration(
    ...
    Reusable function-block types remain single-copy. Each configured physical
    device receives deterministic program variables and independent core,
    binding, and reconfiguration instances.
    """
